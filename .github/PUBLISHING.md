...
2. Add a new pending publisher:
   - **PyPI project name**: lynx-investor-consumer-discretionary
   - **Owner**: `borjatarraso`
   - **Repository**: `lynx-investor-consumer-discretionary`
...
# then:
git tag -a v5.2 -m "lynx-investor-consumer-discretionary v5.2"
