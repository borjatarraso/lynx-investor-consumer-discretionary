...
Binds the consumer-discretionary-specific User-Agent product identifier and wires the agent's
...
from lynx_discretionary import USER_AGENT_PRODUCT
from lynx_discretionary.models import Filing
