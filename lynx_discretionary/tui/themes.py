"""Custom Textual themes for the lynx-discretionary TUI application.
...
THEME_NAMES: List[str] = (
    ["discretionary-dark", "discretionary-light"] + SUITE_THEME_NAMES + ["textual-dark", "textual-light"]
)
