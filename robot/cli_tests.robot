*** Settings ***
Documentation    CLI integration tests for lynx-discretionary
Library          Process
Library          OperatingSystem

*** Variables ***
${PYTHON}        python3
${MODULE}        lynx_discretionary
...
Given The Application Is Available
    Run App    --version
    Should Contain    ${OUTPUT}    lynx-discretionary
...
Show Help
    ...
    Then The Output Should Contain "lynx-discretionary"
...
Show About
    ...
    When I Run About
    Then The Exit Code Should Be 0
    Then The Output Should Contain "Lynx Consumer Discretionary Analysis"
    Then The Output Should Contain "Borja Tarraso"
    Then The Output Should Contain "BSD-3-Clause"

Explain A Valuation Metric
    [Documentation]    GIVEN the app WHEN I explain gross_margin THEN it shows details
    Given The Application Is Available
    When I Explain Metric "gross_margin"
    Then The Exit Code Should Be 0
    Then The Output Should Contain "Gross Margin"

Explain A Consumer-Specific Metric
...
List All Available Metrics
    ...
    Then The Output Should Contain "gross_margin"
...
Explain A Section
    ...
    Given The Application Is Available
    When I Explain Section "business_quality"
    Then The Exit Code Should Be 0
    Then The Output Should Contain "Business Quality"
